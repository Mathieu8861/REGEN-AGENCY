(function() {
    ...
    function initHealingGlow() {
        const cards = document.querySelectorAll('.expertise-card, .value-card, .service-card, .team-card');
    ...
    function initTiltEffect() {
        ...
        const cards = document.querySelectorAll('.expertise-card, .value-card, .testimonial-card, .service-card');
